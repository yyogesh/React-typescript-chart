...
export default function Switches() {
  ...
  const timeStamp = useSelector((state: any) => state.heartbeat);
  const dispatch = useDispatch();
  const activeArr = useSelector((state: any) => state.activeMetrics.selectedMetrics);
  ...
  const handleChange = (name: any) => (event: any) => {
    ...
    if (isChecked) {
      ...
      const metricIndex = activeArr.find((element: any) => element.metricName === metric);
